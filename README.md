...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create blues-stack-defer-02f5
  fly apps create blues-stack-defer-02f5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-defer-02f5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-defer-02f5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'blues-stack-defer-02f5-staging' does not match app name in config file 'blues-stack-defer-02f5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name blues-stack-defer-02f5-db
  fly postgres attach --app blues-stack-defer-02f5 blues-stack-defer-02f5-db

  fly postgres create --name blues-stack-defer-02f5-staging-db
  fly postgres attach --app blues-stack-defer-02f5-staging blues-stack-defer-02f5-staging-db
  ```
